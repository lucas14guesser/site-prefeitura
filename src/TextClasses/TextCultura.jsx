...
const TextCultura = () => {
  return (
    <div className='cultura_container'>
        <div className="main_cultura">
            <Container>
                <div className="text_cultura">
                    <Link to="/" className='link_cultura'>Home</Link>/<Link to='/cultura-e-turismo' className='link_cultura'>Secretaria Municipal de Cultura e Turismo</Link>
                    ...
                    <div className="text_cultura__sec">
                    ...
                    <p>
                        Telefone: <a href="https://api.whatsapp.com/send?phone=4833810048">(48)3381-0048</a>
                        <br /><br />
                        ...
                        <br />
                        ● Escolas de Oleiros Joaquim Antônio de Medeiros Rua Frederico Afonso, 5545, Ponta de Baixo – <a href="https://api.whatsapp.com/send?phone=4833433487">(48)3343-3487</a>
                        <br />
                        ● Teatro ​Hermelinda Izabel Merize Avenida Acioni Souza Filho, s/n – Campinas, Centro de Eventos Multiuso – <a href="https://api.whatsapp.com/send?phone=4832412506">(48)3241-2506</a>
                    </p>
                </div>
            </Container>
        </div>
