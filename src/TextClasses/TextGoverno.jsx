...
import '../Styles/Governo.css'

const TextGoverno = () => {
  return (
    <div className='governo_container'>
        <div className="main_governo">
            <Container>
                <div className="text_governo">
                    <Link to="/" className='link_governo'>Home</Link>/<Link to='/secretaria-de-governo' className='link_governo'>Secretaria de Governo</Link>
                    ...
                    <div className="text_governo__sec">
