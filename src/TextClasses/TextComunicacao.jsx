...
const TextComunicacao = () => {
  return (
    <div className='comunicacao_container'>
        <div className="main_comunicacao">
            <Container>
                <div className="text_comunicacao">
                    <Link to="/" className='link_comunicacao'>Home</Link>/<Link to='/comunicacao-social' className='link_comunicacao'>Secretaria Integrada de Comunicação</Link>
                    ...
                    <div className="text_comunicacao__sec">
...
export default TextComunicacao