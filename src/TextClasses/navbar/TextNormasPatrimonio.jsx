...
const TextNormasPatrimonio = () => {
  return (
    <div className='pag-nav_container'>
        <div className="main_pag-nav">
            <Container>
                <div className="text_pag-nav">
                    <Link to='/' className='link_pag-nav'>Home</Link>/<Link to='/portal-servidor' className='link_pag-nav'>Portal do Servidor</Link>/<Link to='/normas-do-patrimonio' className='link_pag-nav'>Normas do Patrimônio</Link>
...
export default TextNormasPatrimonio