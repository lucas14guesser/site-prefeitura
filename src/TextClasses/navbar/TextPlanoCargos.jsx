...
const TextPlanoCargos = () => {
  return (
    <div className="pag-nav_container">
        <div className="main_pag-nav">
            <Container>
                <div className="text_pag-nav">
                    <Link to='/' className='link_pag-nav'>Home</Link>/<Link to='/portal-servidor' className='link_pag-nav'>Portal do Servidor</Link>/<Link to='/plano-de-cargos' className='link_pag-nav'>Plano de Cargos</Link>
...
export default TextPlanoCargos