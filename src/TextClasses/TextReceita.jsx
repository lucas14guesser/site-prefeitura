...
const TextReceita = () => {
  return (
    <div className='receita_container'>
        <div className="main_receita">
            <Container>
                <div className="text_receita">
                    <Link to="/" className='link_receita'>Home</Link>/<Link to='/secretaria-da-receita' className='link_receita'>Secretaria da Receita</Link>
                    ...
                    <div className="text_receita__sec">
