        ...
        <div className="main_empresa-component">
            <Container>
                <div className="text_empresa-component">
                    <div>
                        <Link to="/" className='link_empresa-component'>Home</Link>/<Link to='/licitacoes' className='link_empresa-component'>Licitações</Link>
                    </div>

                    <h4>Licitações</h4>

                    <h5>Avisos:</h5>
                    <div className="links_empresa-component">
                        <p>
