...
import '../Styles/AssistenciaSocial.css'

const TextAssistenciaSocial = () => {
    return (
        <div className='assistencia_container'>
            <div className="main_assistencia">
                <Container>
                    <div className="text_assistencia">
                        <Link to="/" className='link_assistencia'>Home</Link>/<Link to='/assistencia-social' className='link_assistencia'>Secretaria de Assistência Social</Link>
    
                        <h4>Secretaria de Assistência Social</h4>
                        
                        <h6>Secretária Rita de Cassia Faversani</h6>
                        <div className="text_assistencia__sec">
