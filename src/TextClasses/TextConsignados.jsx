...
import "../Styles/Consignados.css"

const TextConsignados = () => {
  return (
    <div className="consig_container">
        <div className="main_consig">
            <Container>
                <div className="text_consig">
                    <Link to='/' className='link_consig'>Home</Link>/<Link to='/portal-servidor' className='link_consig'>Portal do Servidor</Link>/<Link to='/consignados' className='link_consig'>Consignados</Link>
...
export default TextConsignados