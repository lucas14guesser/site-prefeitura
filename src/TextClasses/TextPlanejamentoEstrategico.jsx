...
import '../Styles/PlanejamentoEstrategico.css'

const TextPlanejamentoEstrategico = () => {
  return (
    <div className='planejamento-estrategico_container'>
        <div className="main_planejamento-estrategico">
            <Container>
                <div className="text_planejamento-estrategico">
                    <Link to="/" className='link_planejamento-estrategico'>Home</Link>/<Link to='/secretaria-de-planejamento-e-assuntos-estrategicos' className='link_planejamento-estrategico'>Secretaria de Planejamento e Assuntos Estratégicos</Link>
                    ...
                    <div className="text_planejamento-estrategico__sec">
...
export default TextPlanejamentoEstrategico