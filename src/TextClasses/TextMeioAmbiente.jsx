...
import '../Styles/MeioAmbiente.css'

const TextMeioAmbiente = () => {
  return (
    <div className='infraestrutura_container'>
        <div className="main_infraestrutura">
            <Container>
                <div className="text_infraestrutura">
                    <Link to="/" className='link_infraestrutura'>Home</Link>/<Link to='/fmads' className='link_infraestrutura'>Fundação Municipal do Meio Ambiente e Desenvolvimento Sustentável</Link>
                    ...
                    <div className="text_infraestrutura__sec">
...
export default TextMeioAmbiente