...
import '../Styles/FundacaoEducacional.css'

const TextFundacaoEducacional = () => {
  return (
    <div className='fund-educacional_container'>
        <div className="main_fund-educacional">
            <Container>
                <div className="text_fund-educacional">
                    <Link to="/" className='link_fund-educacional'>Home</Link>/<Link to='/fundacao-educacional-municipal' className='link_fund-educacional'>Fundação Educacional Municipal</Link>
                    ...
                    <div className="text_fund-educacional__sec">
...
export default TextFundacaoEducacional