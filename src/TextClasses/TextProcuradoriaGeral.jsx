...
import '../Styles/ProcuradoriaGeral.css'

const TextProcuradoriaGeral = () => {
  return (
    <div className='procuradoria_container'>
        <div className="main_procuradoria">
            <Container>
                <div className="text_procuradoria">
                    <Link to="/" className='link_procuradoria'>Home</Link>/<Link to='/procuradoria-geral' className='link_procuradoria'>Procuradoria-Geral do Município</Link>

                    <h4>Procuradoria-Geral do Município</h4>
                    
                    <div className="text_procuradoria__sec">
...
export default TextProcuradoriaGeral