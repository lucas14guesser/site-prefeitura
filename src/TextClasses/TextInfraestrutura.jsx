...
const TextInfraestrutura = () => {
  return (
    <div className='infraestrutura_container'>
        <div className="main_infraestrutura">
            <Container>
                <div className="text_infraestrutura">
                    <Link to="/" className='link_infraestrutura'>Home</Link>/<Link to='/secretaria-de-infraestrutura' className='link_infraestrutura'>Secretaria de Infraestrutura</Link>
...
export default TextInfraestrutura