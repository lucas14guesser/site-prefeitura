...
import '../Styles/RegularizacaoFundiaria.css'

const TextRegularizacaoFundiaria = () => {
  return (
    <div className='reg-fundiaria_container'>
        <div className="main_reg-fundiaria">
            <Container>
                <div className="text_reg-fundiaria">
                    <Link to="/" className='link_reg-fundiaria'>Home</Link>/<Link to='/secretaria-de-regulacao-fundiaria' className='link_reg-fundiaria'>Secretaria de Regularização Fundiária</Link>

                    <h4>Secretaria de Regularização Fundiária</h4>
                    
                    <h6>Secretário Alexandre Rosa</h6>

                    <div className="text_reg-fundiaria__sec">
...
export default TextRegularizacaoFundiaria