...
import "../Styles/PortalServidor.css"

const TextPortalServidor = () => {
  return (
    <div className="pt_serv_container">
        <div className="main_pt_serv">
            <Container>
                <div className="text_pt_serv">
                    <Link to='/' className='link_pt_serv'>Home</Link>/<Link to='/portal-servidor' className='link_pt_serv'>Portal do Servidor</Link>
...
export default TextPortalServidor