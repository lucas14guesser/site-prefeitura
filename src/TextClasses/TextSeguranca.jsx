...
const TextSeguranca = () => {
  return (
    <div className='seguranca_container'>
        <div className="main_seguranca">
            <Container>
                <div className="text_seguranca">
                    <Link to="/" className='link_seguranca'>Home</Link>/<Link to='/secretaria-de-seguranca' className='link_seguranca'>Secretaria de Segurança, Defesa Civil e Trânsito</Link>
                    ...
                    <div className="text_seguranca__sec">
                    ...
                    <p>
                        Telefone: <a href="https://api.whatsapp.com/send?phone=4833817472">(48)3381-7472</a>
                        <br /><br />
