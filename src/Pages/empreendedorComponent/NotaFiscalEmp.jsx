...
const NotaFiscalEmp = () => {
  return (
    <Container>
        <Link to="/" className='link_empreendedor-component'>Home</Link>/<Link to='/empreendedor' className='link_empreendedor-component'>Espaço do Empreendedor</Link>/<Link to='/sou-empresa' className='link_empreendedor-component'>Sou Empresa</Link>/<Link to="/nota-fiscal-emp" className='link_empreendedor-component'>Notas Fiscais</Link>
        ...
        <div className="main_empreendedor-component">
            ...
            <a href="https://saojose.atende.net/autoatendimento/servicos/acesso-ao-sistema-fiscal-web-novo" className='item_empreendedor-component' target='_blank'>
                <img src="../img/souMei/notaFiscal.png" alt="" />
                <small>Quero Emitir Nota Fiscal de <br />Serviço</small>
            </a>
            <a href="https://saojose.atende.net/autoatendimento/servicos/emissao-nota-avulsa" className='item_empreendedor-component' target='_blank'>
                <img src="../img/souMei/notaFiscal.png" alt="" />
